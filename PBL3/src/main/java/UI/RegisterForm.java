...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        ...
        if(nic.length() == 0 || !nic.matches("\\d+")) {
        	JOptionPane.showMessageDialog(null, "nic needs to integer","Error",JOptionPane.ERROR_MESSAGE);
        	return;
        }
        
        if(!Ex.emailTrue(email)) {
        	JOptionPane.showMessageDialog(null, "Email not valid","Error",JOptionPane.ERROR_MESSAGE);
        	return;
        }
        
        if(!Ex.addressTrue(address)) {
        	JOptionPane.showMessageDialog(null, "Not Null","Error",JOptionPane.ERROR_MESSAGE);
        	return;
        }
        
        //validate password length
        if(!Ex.passwordTrue(password)){
